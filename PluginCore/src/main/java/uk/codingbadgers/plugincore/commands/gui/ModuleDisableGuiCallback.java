...
public class ModuleDisableGuiCallback implements GuiCallback {
    ...
    public ModuleDisableGuiCallback(ModulesCommandHandler modulesCommandHandler, ModuleLoader moduleLoader, File moduleFile) {
