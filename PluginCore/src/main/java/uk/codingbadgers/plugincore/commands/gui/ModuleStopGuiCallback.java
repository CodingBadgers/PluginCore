...
public class ModuleStopGuiCallback implements GuiCallback {

    private final Module m_module;
    private final ModuleLoader m_moduleLoader;
    private final ModulesCommandHandler m_modulesCommandHandler;

    public ModuleStopGuiCallback(ModulesCommandHandler modulesCommandHandler, ModuleLoader moduleLoader, Module module) {
        m_module = module;
